...
## Project Structure
    ...
    ├── testapiautostoryboa_72226  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_72226`
...
2. Clone this repo and `cd testapiautostoryboa_72226`
